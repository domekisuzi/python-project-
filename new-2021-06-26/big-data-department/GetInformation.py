...
# 可能需要python 3.8,或者说3.9以下环境,3.9需要该源码
...
def get_student_information():
    ...
    grade = student.col_values(5, START_ROW)
    # map,把所有的信息都缝合起来
    s = map(lambda x, y, z, q, p: (x, y, z, q, p), name, way, id, id_number, grade)
    # print(s)
    result = []
    for i in s:
        result.append(i)
